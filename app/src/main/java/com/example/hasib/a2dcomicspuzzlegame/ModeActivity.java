...
import com.example.securesoftbd.avengersassemble.Model.RevealAnimation;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.hasib.avengersassemble.R.layout.activity_mode);


        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);

        final ImageView easy= (ImageView) findViewById(com.example.hasib.avengersassemble.R.id.easybtn);
        final ImageView medium= (ImageView) findViewById(com.example.hasib.avengersassemble.R.id.mediumbtn);
        final ImageView hard= (ImageView) findViewById(com.example.hasib.avengersassemble.R.id.hardbtn);
    ...
    //    getActionBar().setHomeButtonEnabled(true);
        ...
        easy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                chackHome(1);
                final Animation myAnim = AnimationUtils.loadAnimation(ModeActivity.this, com.example.hasib.avengersassemble.R.anim.bounce);
              ...
              //  intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                ...
                overridePendingTransition(com.example.hasib.avengersassemble.R.anim.enter, com.example.hasib.avengersassemble.R.anim.exit);
...
*/
    ...
    private void setAnimation() {
        LinearLayout linearLayout=findViewById(com.example.hasib.avengersassemble.R.id.layout);
        ImageView icon=findViewById(com.example.hasib.avengersassemble.R.id.icon);
